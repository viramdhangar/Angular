...
<!--[if (gt IE 9)|!(IE)]><!-->
<html class="no-js" lang="en" ng-app="waioApp"> <!--<![endif]-->
<head lang="en">
    <meta charset="UTF-8">
...
<!-- 	<link rel="stylesheet" href="resources/vendor/css/bootstrap.css" /> -->
    <link rel="stylesheet" href="resources/custom/css/app.css" />
    ...
    <script src="resources/vendor/js/angular.js"></script>
    <script src="resources/vendor/js/angular-resource.js"></script>
    <script src="resources/vendor/js/angular-route.js"></script>
...
<script src="resources/custom/js/router/router.js"></script>
<script src="resources/custom/js/controller/formCtrl.js"></script>
<script src="resources/custom/js/controller/coursesCtrl.js"></script>
<script src="resources/custom/js/controller/memberCtrl.js"></script>
<script src="resources/custom/js/controller/syllabusCtrl.js"></script>
<footer>
